      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <th>조회</th>
            <td>
              <span class="badge bdage-primary">${article.hitCount}</span>
            </td>
          </tr>
          <tr>
            <th>추천</th>
            <td>
              <span class="badge bdage-primary">${article.goodReactionPoint}</span>
            </td>
          </tr>
          <tr>
            <th>제목</th>
          ...
          <tr>
            <th>수정</th>
            <td>
              <button type="submit" class="btn btn-outline btn-secondary">수정</button>
