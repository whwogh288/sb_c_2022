  ...
  <div class="container mx-auto px-3">
    <div class="flex">
      ...
      <form class="flex">
        ...
        <button type="submit" class="ml-2 btn btn-outline btn-primary">검색</button>
      </form>
    </div>
    <div class="mt-3">
        ...
        <tbody>
          <c:forEach var="article" items="${articles}">           
            <tr>
              ...
              <td>
                <a class="btn-text-link block w-full truncate" href="${rq.getArticleDetailUriFromList(article)}">
                  ${article.title}
                </a>
              </td>
            </tr>
    ...
    <div class="page-menu mt-3">
      <div class="btn-group justify-center">         
        ...
        <c:forEach begin="${startPage = 1}" end="${endPage = 10}" var="i">
